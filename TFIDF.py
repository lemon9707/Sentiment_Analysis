...
class classify():
    ...
    def LR(self):
        ...
        clf = GridSearchCV(LR(penalty='l2', dual=False, random_state=0),
    ...
    def sgd(self):
        ...
        clf = GridSearchCV(SGD(max_iter=50, random_state=0, loss='modified_huber', n_jobs=4), sgd_params,
...
if __name__ == '__main__':
    process = Preprocessing(
        "./Data/RowData/LabeledTrainData.tsv", "./Data/RowData/TestData.tsv")
